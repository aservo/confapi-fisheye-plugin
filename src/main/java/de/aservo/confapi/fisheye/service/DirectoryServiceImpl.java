...
public class DirectoryServiceImpl implements DirectoriesService {
    ...
    public DirectoriesBean setDirectories(
            DirectoriesBean directoriesBean,
    ...
    public AbstractDirectoryBean setDirectory(
            long id,
            @NotNull AbstractDirectoryBean abstractDirectoryBean,
            boolean testConnection) {
    ...
    private AbstractDirectoryBean setDirectoryCrowd(
            long id,
            @NotNull DirectoryCrowdBean crowdBean,
            boolean testConnection) {
        ...
        DirectoryImpl updatedDirectory = new DirectoryImpl(existingDirectory);
        updatedDirectory.setAttributes(directory.getAttributes());
        updatedDirectory.setDescription(directory.getDescription());
        updatedDirectory.setName(directory.getName());
        updatedDirectory.setActive(directory.isActive());
